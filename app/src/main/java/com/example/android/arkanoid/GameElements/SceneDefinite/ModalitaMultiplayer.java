...
public class ModalitaMultiplayer extends AbstractModalita implements ClientListener, TimerListener {
    private final int TICK_AGGIORNAMENTO_PALLA = 20;               //Intervallo di tempo entro il quale aggiornare la posizione della palla
    ...
    public void timeIsZero() {
        if(this.risorseCaricate){
            try{
                ...
                if(this.isBallOwner && this.client.isServerAlive())
